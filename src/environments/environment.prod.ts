...
export const environment = {
  production: true,
  auth: {
    url: 'https://api-portal.bizdash.app/v1/auth',
  },
  asset: {
  ...
  portal: {
    url: 'https://api-portal.bizdash.app/v1',
    origin: 'https://api-portal.bizdash.app'
  },
  hris: {
    url: 'https://api-hr.bizdash.app/v1',
  },
  formhub: {
    url: 'https://api-formhub.bizdash.app/v1',
    origin: 'https://api-formhub.bizdash.app'
  },
  finance: {
    url: 'https://api-finance.bizdash.app/v1',
  },
  seatmapping: {
    url: 'https://stage-api-seatmapping.bizdash.app/v1',
  },
  payroll: {
    url: 'https://api-payroll.bizdash.app',
  },
  jobshris: {
    url: 'https://hris-job.bizdash.app/v1',
  },
  slack: {
    client_id: '1010123177764.5912390843077',
    client_secret: '8209d538fdefebb28cd6c2420463256d',
    redirect_uri: 'https://formhub.bizdash.app/auth/callback',
    scope: 'users:read',
  ...
  pusher: {
    app_id : "1666946",
    key : "f33d7cda57b9f7037e70",
    secret : "3b0fd04d95f33d210265",
    cluster : "ap1",
    channels: [
      'send-message'
    ]
  ...
  esigUrl : 'esig',
  appVersion: 'v8.1.7',
  appUrl: 'https://formhub.bizdash.app',
  GOOGLE_CLIENT_ID: '695138075022-dltc7ir0no757ssoibbouke7u05dj6l9.apps.googleusercontent.com',
  hrisAdminUrl: 'https://hris.bizdash.app/auth/login',
  esignatureUrl : 'https://esig.bizdash.app/e-signature/auth/login',
